        ...
        <Collapse in={open}>
          <div className='row justify-content-center mt-5'>
            <label htmlFor="profile" className='mb-5'>
              ...
              <img width={'100px'} height={'100px'} className='rounded-circle' src="https://p7.hiclipart.com/preview/184/113/161/user-profile-computer-icons-clip-art-profile.jpg" alt="" />
            </label>
            <div className='mb-4'>
